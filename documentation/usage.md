...
I recommend fixing the lookup to a specific version like this: `https://unpkg.com/sidewind@6.0.0/dist/sidewind.umd.production.min.js`. Doing this will avoid breakage in case a new major version is released.
